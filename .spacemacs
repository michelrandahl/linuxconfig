...
you should place your code here."
  ...
  ;; Loading files for RSL support (rslconvert loads tokenise):
  (load "rsltc.el")
  (load "rsl-mode.el")
  (load "rslconvert.el")
  ...
  ;; Pressing f2 invokes ’do-latex’ on the whole buffer
  ;; Pressing f3 invokes ’undo-latex’ on the whole buffer
