...
NEW_LD_LINUX="/nix/store/wx1vk75bpdr65g6xwxbj4rw0pk04v5j3-glibc-2.27/lib/ld-linux-x86-64.so.2"
...
CPP_LIB_DIR="/nix/store/xbwr3krv4kkyv5h8ici7vkpnsx5w3cv3-gcc-9.3.0-lib/lib/libstdc++.so.6"
